...
def final_score(job,resume):
    ...
    4. Whether experience resuirement is met
...
def parse_resume(resume_text):
    system_prompt=f"""
    You are an expert system resume parser.
    ...
    Skills may also appear in the skills section,work experience,inernships,or projects.
    Return only valid JSON matching this schema.
    {resume_schema}

    Important rules:
    1.do not invent information.
    2.if a value is not avalaible,return null.
    3.if a list has no information,return an empty list.
    4.include internships insdie experience.
